...
private apiUrl = 'http://localhost:3000/posts'; // Ruta completa
  ...
  modificarComentario(comentarioId: string, texto: string): Observable<Comentario> {
  return this.http.put<Comentario>(`${this.apiUrl}/comments/${comentarioId}`, { texto });
}
